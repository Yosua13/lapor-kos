      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white border-[1.5px] border-gray-200 rounded-[20px] p-5 shadow-sm hover:shadow-lg transition-all duration-300 group relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-4">
            <div className="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center text-brand-navy group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300"><Users className="w-5 h-5" /></div>
          ...
          <p className="text-[11px] text-gray-400 font-medium mt-3">dari {rooms.length} kamar tersewa</p>
        </div>

        <div className="bg-white border-[1.5px] border-gray-200 rounded-[20px] p-5 shadow-sm hover:shadow-lg transition-all duration-300 group relative overflow-hidden">
          {/* Top Accent Bar */}
          <div className="absolute top-0 left-0 w-full h-[3px] bg-gray-200 group-hover:bg-emerald-500 transition-colors duration-300"></div>
          
          <div className="flex justify-between items-start mb-4">
            <div className="w-10 h-10 bg-green-50 rounded-xl flex items-center justify-center text-green-500 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300"><CheckCircle2 className="w-5 h-5" /></div>
            <span className="text-[10px] font-bold text-green-600 bg-green-50 px-2.5 py-0.5 rounded-full flex items-center gap-1"><ArrowUp className="w-3 h-3" /> Bulan ini</span>
          </div>
          ...
          <p className="text-[11px] text-gray-400 font-medium mt-3">Penghuni baru bergabung</p>
        </div>
        ...
        <div className="bg-white border-[1.5px] border-gray-200 rounded-[20px] p-5 shadow-sm hover:shadow-lg transition-all duration-300 group relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-4">
            <div className="w-10 h-10 bg-amber-50 rounded-xl flex items-center justify-center text-amber-500 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300"><Calendar className="w-5 h-5" /></div>
            <span className="text-[10px] font-bold text-amber-600 bg-amber-50 px-2.5 py-0.5 rounded-full">Perlu aksi</span>
          </div>
          ...
          <p className="text-[11px] text-gray-400 font-medium mt-3">Dalam 30 hari ke depan</p>
        </div>
        ...
        <div className="bg-white border-[1.5px] border-gray-200 rounded-[20px] p-5 shadow-sm hover:shadow-lg transition-all duration-300 group relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <span className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full ${stats.unpaid > 0 ? 'text-red-600 bg-red-50' : 'text-emerald-600 bg-emerald-50'}`}>{stats.unpaid} tagihan</span>
          </div>
          ...
          <p className="text-[11px] text-gray-400 font-medium mt-3">{stats.unpaid > 0 ? 'Perlu tindak lanjut' : 'Semua lunas'}</p>
        </div>
      </div>
